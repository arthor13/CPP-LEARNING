...
int main()
{
   ...
   /*
        ...
        Para pegar o tamanho de uma array basta utilizar o sizeof da array e dividir o sizeof do tipo de dado dela -> sizeof(name_of_array)/sizeof(data_type_of_the_array)
   ...
   std::string lista[] = {"Lista", "em", "C++"};
    ...
    /*
        Vector em C++
            ...
            Para buscar o primeiro valor de um vector basta utilizar -> vector.name_front() 
            Para buscar o último valor de um vector basta utilizar -> vector_name.back()
            Para buscar o tamanho de um vector basta utilizar -> vector_name.size()
